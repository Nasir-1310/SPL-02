# helper file of DroidInspect
# it parses command arguments and send the options to DroidInspect
import argparse
from DroidInspect import input_manager
from DroidInspect import input_policy
from DroidInspect import env_manager
from DroidInspect import DroidInspect
from DroidInspect.droidmaster import DroidMaster
...
def parse_args():
    ...
    """
    parser = argparse.ArgumentParser(description="Start DroidInspect to test an Android app.",
    ...
    parser.add_argument("-is_emulator", action="store_true", dest="is_emulator",
                        help="Declare the target device to be an emulator, which would be treated specially by DroidInspect.")
    ...
    parser.add_argument("-replay_output", action="store", dest="replay_output",
                        help="The DroidInspect output directory being replayed.")
...
def main():
    """
    the main function
    it starts a DroidInspect according to the arguments given in cmd line
    """
    opts = parse_args()
    import os
